                ...
                <div class="form-container">
                    <div class="left-content">
                        <div style="display: flex; align-items: center;">
                            <svg xmlns="http://www.w3.org/2000/svg" height="40" width="36" style="margin-bottom: 70px"
                                viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                <path fill="#ffffff"
                                    d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z" />
                            </svg>
                            <h3 class="title" style="margin-bottom: 70px; margin-left: 20px;">Michael J <br>
                                Adil</h3>
                        </div>
                        <form class="form-horizontal">
                            <button class="btn kiri" style="margin-top: 20px">
                                ...
                                </svg><span>Edit Profil</span></button>
                            <button href="/edit_akun" class="btn kiri" style="margin-top: 20px"><svg xmlns="http://www.w3.org/2000/svg"
