            ...
            <div class="col-md-offset-2 col-md-8">
                <div class="form-container">
                    <div class="left-content">
                        <h3 class="title" style="margin-bottom: 5px">Michael J</h3>
                        <h3 class="title" style="margin-bottom: 70px">Adil</h3>
                        <form class="form-horizontal">
                            <button class="btn kiri" style="margin-top: 20px">
                            ...
                            <button class="btn kiri" style="margin-top: 20px"><svg xmlns="http://www.w3.org/2000/svg"
                                    height="17" width="18.75" style="position: relative; left: -35px;"
                                    viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                    <path fill="#ffffff"
                                        d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24 10.7 24 24s-10.7 24-24 24H199.7c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5H24C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96z" />
                                </svg><span>Pesanan Saya</span></button>
                            <button class="btn kiri" style="margin-top: 20px"><svg xmlns="http://www.w3.org/2000/svg"
                                    height="17" width="18.75" style="position: relative; left: -55px;"
                                    viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                    <path fill="#ffffff"
                        ...
                        <form class="form-horizontal" style="margin-top: 50px">
                            <div class="form-group">
                                ...
                                <output class="form-control"
                                    style="background-color: rgb(255, 255, 255); font-size: 20px; color: black">Michael
                                    J Adil</output>
                            </div>
                            <div class="form-group">
                                <label style="color: black">No Hp :</label>
                                <output class="form-control"
                                    style="background-color: rgb(255, 255, 255); font-size: 20px; color: black">+62 8257
                                    0976 1290</output>
                            </div>
                            <div class="form-group">
                                <label style="color: black">Email :</label>
                                <output class="form-control"
                                    style="background-color: rgb(255, 255, 255); font-size: 20px; color: black">michael4archangel@gmail.com</output>
                            </div>
                        </form>
                    </div>
                </div>
