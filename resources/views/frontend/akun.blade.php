                        ...
                        <form class="form-horizontal" style="margin-top: 50px">
                            <div class="form-group">
                                ...
                                <output class="form-control"
                                    style="background-color: rgb(255, 255, 255); font-size: 18px; color: black; font-weight: bold">{{ auth()->user()->nama }}</output>
                            </div>
                            <div class="form-group">
                                <label style="color: black">Nomor Hp :</label>
                                <output class="form-control"
                                    style="background-color: rgb(255, 255, 255); font-size: 18px; color: black; font-weight: bold">{{ auth()->user()->hp }}</output>
                            </div>
                            <div class="form-group">
