            ...
            <div class="col-md-8 offset-md-2">
                @if (session()->has('sukses'))
                    <div class="alert alert-success alert-dismissible" role="alert">
                        <h4 style="font-family: Poppins, sans-serif">{{ session('sukses') }}</h4>
                        ...
                        <form class="form-horizontal" style="margin-top: 50px">
                            <div class="form-group">
                                ...
                                <output class="form-control"
                                    style="background-color: rgb(255, 255, 255); font-size: 20px; color: black; font-weight: bold">{{ auth()->user()->nama }}</output>
                            </div>
                            <div class="form-group">
                                <label style="color: black">No Hp :</label>
                                <output class="form-control"
                                    style="background-color: rgb(255, 255, 255); font-size: 20px; color: black; font-weight: bold">{{ auth()->user()->hp }}</output>
                            </div>
                            <div class="form-group">
                                <label style="color: black">Email :</label>
                                <output class="form-control"
                                    style="background-color: rgb(255, 255, 255); font-size: 20px; color: black; font-weight: bold">{{ auth()->user()->email }}</output>
                            </div>
                        </form>
                    </div>
                </div>
