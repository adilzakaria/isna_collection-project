                ...
                <div class="form-container" style="margin-top: -35px;">
                    <div class="row">
                        <div class="col-md-6 left-content">
                            ...
                            <svg xmlns="{{ url('http://www.w3.org/2000/svg') }}" height="40" width="36"
                        ...
                        <form class="form-horizontal" action="{{ route('logout') }}" method="POST">
                            ...
                            <a href="{{ route('edit_akun') }}" class="btn kiri" style="margin-top: 20px">
                                <svg xmlns="{{ url('http://www.w3.org/2000/svg') }}" height="17" width="17"
                                    style="position: relative; left: -9%; top: -20%; transform: translate(-50%, -20%);"
                                    viewBox="0 0 512 512">
                                    <path fill="#ffffff"
                            ...
                            <button type="submit" class="btn kiri" style="margin-top: 20px"><svg
                                ...
                                </svg><span style="font-size: 1em;">Keluar</span></button>
                        </form>
                    </div>
                            ...
                            @foreach ($pesanan as $pesan)
                                <div class="card mb-5">
                                    <div class="form-group m-3">
                                        ...
                                        <h5 for="" class="text-dark">Estimasi Waktu : {{ $pesan->estimasi }}
                                        </h5>
                                        <h5 class="text-dark" style="display: inline-block;">Status Pesanan : </h5>
                                        <h5 class="text" style="display: inline-block; color:
                                            @if ($pesan->status == 'DISETUJUI') blue;
                                            @elseif($pesan->status == 'TELAH MEMBAYAR') green;
                                            @elseif($pesan->status == 'TIDAK DISETUJUI') red;
                                            @else black;
                                            @endif">
                                            {{ $pesan->status }}
                                        </h5>
