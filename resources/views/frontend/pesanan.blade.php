    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-5">
           <div class="card border-card" style="height: 100%;">
                ...
                <output class="form-control my-3">Kameja Wanita</output>
                <output class="form-control my-3">L</output>
                <input type="text-area" style="width: 100%; height: 30%;">
                <h6 class="my-3">Total Harga : - </h6>
                ...
                <button type="submit" class="btn btn-body kirim" style="width: 40%; height: font-size: 14px;">Bayar</button>
                </div>
           </div>
        </div>
    </div>
