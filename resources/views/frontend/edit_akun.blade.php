                ...
                <div class="form-container">
                    <div class="left-content">
                        <div style="display: flex; align-items: center;">
                            ...
                            <a class="title" style="margin-bottom: 70px; margin-left: 20px;" href="/akun">{{ auth()->user()->nama }}</a>
                        </div>
                        <form class="form-horizontal" action="/logout" method="POST">
                            ...
                            <button type="submit" class="btn kiri" style="margin-top: 20px"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="right-content" style="border-bottom-right: 15px; border-top-right-radius: 15px;">
                        ...
                        <form class="form-horizontal" style="margin-top: 30px" action="/edit_akun" method="POST">
                            ...
                            <button type="button" class="btn btnkanan" style="margin-top: 20px; float: right;">Batal</button>
                        </form>
                    </div>
                </div>
            </div>
